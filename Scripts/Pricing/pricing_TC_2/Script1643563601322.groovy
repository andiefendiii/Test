...
WebUI.click(findTestObject('Object Repository/Page_Qlue Smart City  Beyond Innovation, Dr_47ce46/a_PRICING'))
...
WebUI.click(findTestObject('Object Repository/Page_Qlue Smart City  Cart/span_'))

WebUI.click(findTestObject('Object Repository/Page_Qlue Smart City  Cart/button_ADD_1'))

WebUI.doubleClick(findTestObject('Object Repository/Page_Qlue Smart City  Cart/span_'))
